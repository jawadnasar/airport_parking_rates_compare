            ...
            if (product_card && product_card.length > 0) {
                ...
                product_card.forEach((card, i) => {
                    ...
                    pricing_data_obj.push({
                        ...
                        'price': 11,
                        'from_date': '2026-09-09', // from date like "Mon, 20 Nov 2023"
                        'from_time': '12:00:00', //to24HourFormat(document.getElementsByClassName('date-time-picker__value')[1].innerText.trim()), // from time like "10:00 AM"
                        'to_date': '2026-09-09', // to date like "Tue, 21 Nov 2023"
                        'to_time': '12:00:00', //to24HourFormat(document.getElementsByClassName('date-time-picker__value')[3].innerHTML.trim()), // to time like "10:00 AM"
                        'airport_name': 'gtw', //document.querySelector('.airport-select input').value.trim(), // airport name like "London Heathrow Airport"
                        'parking_type': '',
                        'transfer_time': '10min',// product_card[i].querySelector('.transfer-text').innerText.trim(),
                        'website_id': 2
                    });
                });
